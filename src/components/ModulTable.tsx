...
export default function ModulTable({ data, formInput, onBack, mode }: ModulTableProps) {
      ...
      <table class="identity-table">
        <tr>
          <td width="50%">
            ...
            ${(activeTab !== 'soal' || (mode !== 'sts' && mode !== 'sas')) ? `<b>MATERI POKOK</b>: ${currentMaterial}` : ''}
          </td>
          <td>
        ...
        <table class="spreadsheet-table">
          ...
          ${(data?.kisiKisi || []).map(k => `
            <tr>
              ...
              <td><b>CP:</b> ${formInput.cp}<br><b>TP:</b> ${k.tp || `Menganalisis indikator materi berkaitan dengan ${currentMaterial}`}</td>
  ...
  // PERBAIKAN SINTAKS: Definisikan tipe LucideIcon secara eksplisit menghindari data 'any'
    ...
    <div className="max-w-5xl mx-auto space-y-8 pb-32">
      <style dangerouslySetInnerHTML={{ __html: `
        @media print {
          ...
          .spreadsheet-table th:nth-child(1):nth-last-child(5), .spreadsheet-table td:nth-child(1):nth-last-child(5) { width: 6% !important; }
          .spreadsheet-table th:nth-child(2):nth-last-child(4), .spreadsheet-table td:nth-child(2):nth-last-child(4) { width: 48% !important; }
          .spreadsheet-table th:nth-child(3):nth-last-child(3), .spreadsheet-table td:nth-child(3):nth-last-child(3) { width: 26% !important; }
          .spreadsheet-table th:nth-child(4):nth-last-child(2), .spreadsheet-table td:nth-child(4):nth-last-child(2) { width: 10% !important; }
          .spreadsheet-table th:nth-child(5):nth-last-child(1), .spreadsheet-table td:nth-child(5):nth-last-child(1) { width: 10% !important; }
          
          .spreadsheet-table th:nth-child(1):nth-last-child(3), .spreadsheet-table td:nth-child(1):nth-last-child(3) { width: 6% !important; }
          .spreadsheet-table th:nth-child(2):nth-last-child(2), .spreadsheet-table td:nth-child(2):nth-last-child(2) { width: 14% !important; }
          .spreadsheet-table th:nth-child(3):nth-last-child(1), .spreadsheet-table td:nth-child(3):nth-last-child(1) { width: 80% !important; }
                    ...
                    {generatedImages[q.number] ? (
                      <div className={cn(
                        ...
                        <button
                          ...
                          className="absolute top-2 right-2 no-print bg-white/90 backdrop-blur shadow-lg p-2 rounded-lg text-citrus-600 hover:text-citrus-800 opacity-0 group-hover:opacity-
